...
export const currentSchemaVersion = 1707233800000; // use `new Date().getTime()`
...
export const migrations: Migration[] = [
	...
	{
		version: 1707233800000,
		stmts: [
			"CREATE INDEX network_channel_time ON messages (network, channel, time DESC)",
		],
	},
];
...
export const rollbacks: Rollback[] = [
	...
	{
		version: 1707233800000,
		stmts: ["DROP INDEX network_channel_time"],
	},
];
